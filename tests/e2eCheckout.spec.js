...
const dataset = JSON.parse(JSON.stringify(require('../resources/userdetails.json')));

for(const data of dataset){

    test(`E2E test for ${data.productName} product checkout `, async ({ page }) => {
        ...
        const orderIDWithSpace = await page.locator('.em-spacer-1 .ng-star-inserted').first().textContent();
